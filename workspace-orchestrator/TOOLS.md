...
## 2. 默认能力方向
- Read state, policy, schema, workflow
- Route tasks and manage sessions
- Read coordination artifacts

## 3. 默认受限方向
- No direct runtime mutation outside policy
- No destructive ops or deploy
- No broad writes
