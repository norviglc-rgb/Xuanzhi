...
- `powershell -NoProfile -NonInteractive -ExecutionPolicy Bypass -File scripts/workflow-materialize-core-agents.ps1`
...
- `powershell -NoProfile -NonInteractive -ExecutionPolicy Bypass -File scripts/workflow-create-daily-user.ps1`
...
- `powershell -NoProfile -NonInteractive -ExecutionPolicy Bypass -File scripts/workflow-memory-promote.ps1`
...
- `powershell -NoProfile -NonInteractive -ExecutionPolicy Bypass -File scripts/workflow-replay-r4.ps1`
